...
func (t *WebSearchTool) Info() tool.ToolInfo {
	return tool.NewToolInfo(
		"web_search",
		"Search the web via DuckDuckGo and return ranked results with title, URL, and snippet. Use to look up CVEs for library versions, research SDKs, or find known vulnerability patterns.",
		WebSearchParams{},
	)
}

func (t *WebSearchTool) Run(
	ctx context.Context,
